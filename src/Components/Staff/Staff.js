                ...
                <div className="staff-content">
                    ...
                    <div className="staff-card">
                        <div className="staff-individual">
                            ...
                            <p className="staff-subinfo">Cres Casimong has been the lead pastor of New Life Alliance Church for 20 years starting in October 2024. He is the National Coordinator of the Conference of Filipino Alliance Ministries (CFAM), a consortium of Filipino Alliance Churches of C&MA Canada. He holds a Bachelor of Arts in Biblical Studies from Ambrose University, a Master of Divinity from Carey Theological College as well as a Doctorate from Carolina University. Cres currently resides in Surrey, BC with his wife Niña Casimong. Together they have three children and two grandchildren.</p>
                        </div>
                        <div className="staff-individual">
